...
<template>
  <DialogRoot :open="modelValue" @update:open="(v) => emit('update:modelValue', v)">
    <DialogPortal>
      ...
      />
      <DialogContent
        :class="[SIZE_CLASSES[props.size], 'surface-dialog fixed left-1/2 top-1/2 z-50 flex max-h-[85vh] w-full flex-col -translate-x-1/2 -translate-y-1/2 rounded-[var(--radius-xl)] duration-[var(--duration-normal)] ease-[var(--ease-out-expo)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-48% data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-48%']"
      >
