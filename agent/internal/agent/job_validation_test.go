...
func TestUnsignedJobRejectedWhenEnforced(t *testing.T) {
	...
	res := validateAndAuthorize(cfg, v, rp, testAgentID, "job-1", "SERVICE",
...
func TestReplayRejected(t *testing.T) {
	...
	if res := validateAndAuthorize(cfg, v, rp, testAgentID, "job-1", "PACKAGE_UPDATE", params, "", now); res != nil {
	...
	if res := validateAndAuthorize(cfg, v, rp, testAgentID, "job-2", "PACKAGE_UPDATE", params2, "", now); res == nil {
...
func TestWrongAgentRejected(t *testing.T) {
	...
	res := validateAndAuthorize(cfg, v, rp, testAgentID, "job-1", "REBOOT", params, "", now)
...
func TestUnknownJobTypeRejectedWhenEnforced(t *testing.T) {
	...
	res := validateAndAuthorize(cfg, v, rp, testAgentID, "job-1", "TOTALLY_NEW_TYPE", params, "", now)
