...
from lokilinux.schemas.alert import AlertResponse, AlertRuleResponse
...
@router.get("/", response_model=CursorPage[AlertResponse])
...
@router.get("/rules", response_model=CursorPage[AlertRuleResponse])
