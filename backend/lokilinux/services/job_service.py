...
class JobService:
    ...
    async def create_job(
        ...
        try:
            ...
            # TOCTOU: another request won the same dedup_key between our
            # check above and this commit — same outcome as the check
            # catching it, just a race instead of a stale read.
